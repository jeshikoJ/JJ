...
const CHAPTERS: Chapter[] = [
  {
    ...
    title: (
      <>
        I&rsquo;m Jeshiko J — I build infrastructure that{" "}
        <em className={styles.serif}>scales.</em>
      </>
    ),
    body: "DevOps Engineer & Cloud Architect specializing in AWS infrastructure automation, CI/CD pipeline design, Terraform, Docker, Kubernetes, and System Reliability Engineering.",
  },
  {
    label: "Engineering Foundations",
    title: (
      <>
        Graduated with B.E. in{" "}
        <em className={styles.serif}>Computer Science.</em>
      </>
    ),
    body: "Graduated May 2025 from Bethlahem Institute of Engineering. Built strong computer science fundamentals across database systems, cloud computing, software engineering, and Linux administration.",
  },
  {
    label: "DevOps & CI/CD",
    title: (
      <>
        ...
        <em className={`${styles.serif} ${styles.red}`}>automation.</em>
      </>
    ),
    body: "Reduced software deployment time cycles by 70% through Jenkins master-slave CI/CD pipelines, Ansible configuration playbooks, and GitHub Actions workflows.",
  },
  {
    ...
    title: (
      <>
        ...
        <em className={styles.serif}>security.</em>
      </>
    ),
    body: "Architected multi-tier AWS network blueprints featuring granular IAM least-privilege policies, security groups, and PostgreSQL multi-AZ replication with 100% data integrity.",
  },
  {
    label: "Serverless & Latency",
    title: (
      <>
        Optimized performance &amp;{" "}
        <em className={`${styles.serif} ${styles.red}`}>reliability.</em>
      </>
    ),
    body: "Achieved a 40% reduction in API response latency utilizing serverless computing patterns, raw query optimizations, and containerized Docker microservices.",
  },
  {
    label: "SRE & Uptime",
    title: (
      <>
        99.5% verified pipeline{" "}
        <em className={styles.serif}>success rate.</em>
      </>
    ),
    body: "Eliminated 60% of environment-specific deployment bugs via standardized Docker containerization and continuous integration testing.",
  },
  {
    label: "Vision",
    title: (
      <>
        Engineered for what&rsquo;s{" "}
        <em className={`${styles.serif} ${styles.red}`}>next.</em>
      </>
    ),
    body: "Dedicated to designing resilient, self-healing cloud systems and automated delivery pipelines that enable modern software teams to ship with speed and total confidence.",
  },
];
